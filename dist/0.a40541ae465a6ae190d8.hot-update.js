	...
	renderedPageRouter.get('*', function (req, res) {
	  (0, _reactRouter.match)({ routes: _Routes2.default, location: req.url }, function (error, redirectLocation, renderProps) {
	    if (error) {
	      ...
	      var dataFetchers = componenstWithData.map(function (c) {
	        return c.dataFetcher({ params: renderProps.params,
	          location: renderProps.location, urlBase: 'http://localhost:300'
	        });
	      });
...
//# sourceMappingURL=0.a40541ae465a6ae190d8.hot-update.js.map